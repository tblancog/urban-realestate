        ...
        <div class="col-md-6 col-sm-12">
            ...
            <div class="row">
                    ...
                    <div class="">
                        <ul class="amenitieBox list-inline">
                            ...
                            <li class="list-inline-item">
                                <img class="amenitieIcon" src="/img/icons/amenities/{{ $amenity->icon }}"
                                    alt="{{ $amenity->title }}">
                ...
                <div class="col-md-12 col-sm-12 boxDetail">
                    ...
                    <form class="formDetail formDepto" method="POST" action="{{ route('mail.buildings', ['slug' => $building->slug ]) }}">
                        @csrf
                        <div class="contact-info">
                            ...
                            <div class="contact-info-item">
                                <textarea name="message" style="white-space: pre-line;" name="Mensaje" id="" cols="30"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('apartments.show', $ap->slug) }}"><i
