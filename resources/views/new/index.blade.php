...
<html lang="en">
  <head>
    ...
    <link href="new/css/front.css" rel="stylesheet">
  </head>
  ...
  <body>
    ...
    <a class="navbar-brand col-5" href="#"><img src="new/img/logoUrban.png" alt=""></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
        ...
        <li class="nav-item active">
            ...
            <i class="fab fa-facebook-f"></i> INVERSIONES
            <span class="sr-only">(current)</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
            <i class="fab fa-instagram"></i> TASACIONES</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
        ...
        <li class="nav-item dropdown">
            ...
            <a class="dropdown-item" href="#">PROPIEDADES DESTACADAS</a>
            <a class="dropdown-item" href="#">PROPIEDADES</a>
            <a class="dropdown-item" href="#">CRÉDITO HIPOTECARIO</a>
            <a class="dropdown-item" href="#">FINANCIAZIÓN</a>
...
<!--/.Carousel Wrapper-->
    ...
    <script>window.jQuery || document.write('<script src="new/js/jquery-3.2.1.slim.min.js"><\/script>')</script>
