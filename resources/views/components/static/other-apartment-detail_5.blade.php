                            ...
                            <div id="myCarousel" class="carousel slide">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="active carousel-item" data-slide-number="0">
                                        <img src="{{ asset('/images/uploads/other-apartment-detail_5/apartment_1.png') }}" class="img-fluid">
                                    </div>
                                    <div class="carousel-item" data-slide-number="1">
                                        <img src="{{ asset('/images/uploads/other-apartment-detail_5/apartment_2.png') }}" class="img-fluid">
                                    </div>
                                    ...
                                    <div class="carousel-item" data-slide-number="1">
                                        <img src="{{ asset('/images/uploads/feature-building-detail_1/detail_2.JPG') }}" class="img-fluid">
                                    </div>
                                    <div class="carousel-item" data-slide-number="2">
                                        <img src="{{ asset('/images/uploads/feature-building-detail_1/detail_3.JPG') }}" class="img-fluid">
                                    </div>
            ...
            <div class="dept-description mt-4">
                ...
                <div class="description-bot">
                    ...
                    <p class="description-body">
                        - PH de categoría con cochera y amenities varios: piscina/ solárium - parrilla - sum – terraza – cocheras
                ...
                <div class="dept-map mt-4">
                    <div class="map-top">
                        ...
                        <div class="map-socialmedia">
                            <a href="#" target="_blank"><img src="/img/icons/whatsapp.svg"
                                    alt="Whatsapp"></a>
                            <a href="#" target="_blank"><img src="/img/icons/facebook.svg"
                                    alt="Facebook"></a>
                            <a href="#" target="_blank"><img src="/img/icons/instagram.svg"
                                    alt="Instagram"></a>
                        </div>
                    </div>
                    <div class="map-bot">
